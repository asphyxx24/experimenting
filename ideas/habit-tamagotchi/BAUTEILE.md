...
> Zubehör für den Jarvis-Companion-Build auf Basis der **Waveshare ESP32-S3-Touch-LCD-1.28** (37 mm rund, 1.28″ GC9A01-Display, kapazitiver Touch, IMU on-board, USB-C, LiPo-Charger).
...
|------|------|-------|-------|-------|
| **LiPo-Akku 500 mAh** | 503035 (5×30×35 mm), JST MX1.25, **mit Protection Board** | ~4–6 € | eBay / AliExpress | Direkt ans Board stecken, kein Adapter nötig |
| POGO-Pin Magnet-Charger (4-Pol) | 2.5 × 4 mm | ~5 € | AliExpress | Optional: kein USB-C-Stöpseln mehr |

**Wichtig:** Polarität des LiPo-Anschlusses am Board prüfen, bevor anstecken — falscher Pol = totes Board.
**Wichtig:** Nur Akku **mit Protection Board / PCB** kaufen — schützt gegen Tiefentladung und Kurzschluss.
...
| Teil | Spec | Preis | Bezug | Notiz |
|------|------|-------|-------|-------|
| **INMP441 I2S MEMS-Mikro** | 14×4 mm | ~3 € | Berrybase / AliExpress | Voice-Capture, sauberes Signal |
| **MAX98357A I2S-Verstärker** | 18×14 mm | ~3 € | Berrybase / AliExpress | Speaker-Treiber |
| **Mini-Speaker 8 Ω 1 W** | 13 mm rund | ~2 € | AliExpress | Antwort-Wiedergabe |
...
| Teil | Spec | Preis | Bezug | Notiz |
|------|------|-------|-------|-------|
| **MAX30102 PPG-Modul** | 14×14 mm, I2C | ~5 € | Berrybase / AliExpress | Puls + SpO2 + HRV → Schlaftracking |
| SHT41 Temp+Humid | Breakout 10×10 mm | ~5 € | Berrybase | Nice-to-have, später nachrüsten |
...
| **220 Ω Widerstand** | 0.25 W | ~0.05 € | Reichelt | Strombegrenzung Basis |
| **100 Ω Widerstand** | 0.25 W | ~0.05 € | Reichelt | LED-Strombegrenzung |
| **TSOP38238 IR-Receiver** | 5×6 mm | ~1 € | Reichelt / AliExpress | Fernbedienungen "anlernen" |
...
| Teil | Spec | Preis | Bezug | Notiz |
|------|------|-------|-------|-------|
| **Mikro-Taster 6×6×4.3 mm** | THT, tactile | ~0.20 €/Stk | Reichelt | Feed / Play / PTT — 10 Stück kaufen |
| **Side-Push-Schalter** | für Crown-Position | ~1 € | AliExpress | PTT-Knopf, Smartwatch-Look |
| **WS2812B RGB-LED** | 5×5 mm einzeln | ~0.50 € | AliExpress | Stimmungs-Farbe ("atmen") |
| **Coin-Vibrationsmotor** | 8×3 mm | ~2 € | AliExpress | Stille Notifications |
...
| POGO-Pin Magnet-Charger | 4-Pol, 2.5×4 mm | ~5 € | AliExpress | Nice-to-have |
...
| LiPo 503035 500mAh JST MX1.25 (mit PCB) | ~5 € |
| INMP441 Mikro | ~3 € |
| MAX98357A + 8-Ω-Speaker 1W 13mm | ~5 € |
| MAX30102 (Puls/SpO2/Sleep) | ~5 € |
| IR-LED 940nm + TSOP38238 + 2N2222 + Widerstände | ~2 € |
| 3× Mikro-Taster 6×6 + 1× Side-Push (PTT) | ~2 € |
| WS2812B RGB-LED | ~1 € |
...
| Shop | Wofür |
|------|-------|
| **eBay / AliExpress** | Akku 503035 MX1.25 (mit PCB), Watch-Case, Armband |
